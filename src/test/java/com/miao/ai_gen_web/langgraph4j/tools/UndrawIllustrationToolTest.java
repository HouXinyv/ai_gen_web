package com.miao.ai_gen_web.langgraph4j.tools;

import com.miao.ai_gen_web.langgraph4j.model.ImageCategoryEnum;
import com.miao.ai_gen_web.langgraph4j.model.ImageResource;
...
class UndrawIllustrationToolTest {
    ...
    void testSearchIllustrations() {
        // 测试正常搜索插画
        List<ImageResource> illustrations = undrawIllustrationTool.searchIllustrations("cat");
