...
import com.miao.ai_gen_web.langgraph4j.model.QualityResult;
import com.miao.ai_gen_web.langgraph4j.node.*;
...
//                            ))
            ...
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "工作流创建失败"+e);
        }
    }
